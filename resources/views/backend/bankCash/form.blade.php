...
@section('title', 'Bank Cash Create')
        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Bank Cash Create</span>
                </h3>
                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                     title="Click to bank cash list"
                     data-bs-original-title="Click to bank cash list">
                    <a href="{{ route('admin.bankCash.index') }}" class="btn btn-sm btn-light btn-active-primary">
            ...
            <div class="card-body py-3">
                ...
                <form class="form" method="POST"
                      action="{{ isset($editModeData) ? route('admin.bankCash.update', $editModeData->id) : route('admin.bankCash.store') }}">
                    @csrf
