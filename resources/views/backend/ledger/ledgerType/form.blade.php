...
@section('title', 'Ledger Type Create')
        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Ledger Type Create</span>
                </h3>
                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                     title="Click to ledger type list"
                     data-bs-original-title="Click to ledger type list">
                    <a href="{{ route('admin.ledgerType.index') }}" class="btn btn-sm btn-light btn-active-primary">
            ...
            <div class="card-body py-3">
                ...
                <form class="form" method="POST" id="kt_project_form"
                      action="{{ isset($editModeData) ? route('admin.ledgerType.update', $editModeData->id) : route('admin.ledgerType.store') }}">
                    @csrf

                    @isset($editModeData)
                        @method('PUT')

                        <input type="text" hidden name="ledger_type_id" value="{{ $editModeData->id }}">
                    @endisset
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6 fv-row mb-5">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ $editModeData->code ?? old('code') }}"/>
                            @error('code')
                            <span class="text-danger mt-2">{{ $message }}</span>
                            @enderror
                        </div>
