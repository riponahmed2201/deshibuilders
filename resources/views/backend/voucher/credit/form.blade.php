...
@section('title', 'Credit Voucher Create')
        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Credit Voucher Create</span>
                </h3>
                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                     title="Click to credit voucher list"
                     data-bs-original-title="Click to credit voucher list">
                    <a href="{{ route('admin.creditVoucher.index') }}" class="btn btn-sm btn-light btn-active-primary">
            ...
            <div class="card-body py-3">
                ...
                <form class="form" method="POST"
                      action="{{ isset($editModeData) ? route('admin.creditVoucher.update', $editModeData->id) : route('admin.creditVoucher.store') }}">
                    @csrf
